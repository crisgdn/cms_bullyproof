...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 16, 2023 at 11:17 PM
...
INSERT INTO `events` (`id`, `card`, `name`, `date`, `text`) VALUES
(1, 'event 1', 'Bully Proof Hockey Camp', 'MARCH 27, 2023', 'Join our charity hockey event by playing, celebrating, saying words of encouragement and being kind.'),
(2, 'event 2', 'Bully Proof Hockey Fans', 'MARCH TO DECEMBER,2023', 'Let’s cheer for officials and players! Be a fan and celebrate the wins and the fails of both teams.'),
(3, 'event 3', 'Bully Proof Tims Contest', 'JANUARY TO DECEMBER, 2023', 'Take a picture with a official or members of the other team and post on Instagram or twitter using the hashtag #bullyproofhockey.');
